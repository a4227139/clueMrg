...
@Slf4j
public class CallLogListenerBak implements ReadListener<CallLog> {
     ...
     * @param callLogMapper
     */
    public CallLogListenerBak(CallLogMapper callLogMapper) {
        this.callLogMapper = callLogMapper;
    }

    public CallLogListenerBak() {
    }
    ...
    private void saveData() {
        ...
        callLogMapper.batchInsertCallLog(cachedDataList);
        log.info("存储数据库成功！");
    }
}
