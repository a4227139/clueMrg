...
public class BtClueController {
    ...
    private void generateExcel(String clueId,ZipOutputStream zipOut) throws Exception {
        ...
        String btExcelFileName = ROOT_APPLICATION_PATH+separator+"btclue"+separator +clueId+ separator+ btFileName;
        //创建文件夹
        File directory = new File(ROOT_APPLICATION_PATH+separator+"btclue"+separator +clueId+ separator);
        if (!directory.exists()) {
        ...
        String callLogExcelFileName = ROOT_APPLICATION_PATH+separator+"btclue"+separator +clueId+ separator+ callLogFileName;
    ...
    private void generateWord(String clueId,ZipOutputStream zipOut) throws Exception {
        ...
        String wordFileName = ROOT_APPLICATION_PATH+separator+"btclue"+separator+clueId+separator+ fileName;
